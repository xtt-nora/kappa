    ...
    <div class="targets-preview">
      <n-card :title="$t('menu.preview')">
        <div class="tool">
          ...
          <n-select
            v-model:value="value"
            :options="[{ label: 'HD4-63井流梯', value: 'testedWell-1' }]"
          ></n-select>
        </div>
...
const value = ref("testedWell-1");

const checkedKeys = ref(["history"]);
const treeData = computed(() => [
  ...
  },
  {
    ...
    children: [
      {
        label: t("menu.testedWell"),
        key: "testedWell",
        prefix: () => h(SvgIcon, { name: "wellsGroupS" }),
        children: [
          {
            label: "HD4-63井流梯",
            key: "testedWell-1"
...
const iconOptions = ref([
  { icon: "tsFilterL", key: "first" },
  { icon: "RTADeconvolution", key: "stop" },
  { icon: "SingleLineL", key: "singleLine" },
  { icon: "tsFilterResetL", key: "play" }
]);
